         ...
         <div class="col">
            ...
            <div class="midlle">
               ...
               <form action="favorite.php" method="post">
                  ...
                  <button type="submit" class="inBtn" name="add"><i class="fa-regular fa-star"></i> Добави в любими</button><span class="mess"><?php echo $_SESSION['message']; unset($_SESSION['message']);?></span>
               </form>
               <div>
                  <form action="" method="post">
                     <button type="submit" name='productN' class="inBtn"><i class="fa-solid fa-repeat"></i> Сравни продукта</button><span class="mess"> <?php echo $add;                                                                                                                                     echo $done ?></span>
                  </form>
               </div>
            </div>
            ...
            <div class="panels">
               ...
               <div class="panel d-none" id="three-panel">
                  ...
                  <div class="commSection">
                     ...
                     ?>
                           <div class="boxxx">
                              <div class="nammee"><span>Име: </span><?php echo $row['name']; ?>: <?php echo $row['date']; echo ' '.$timee ?></div>
                              <div class="bo"></div>
